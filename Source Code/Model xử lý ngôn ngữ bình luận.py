...
Original file is located at
    https://colab.research.google.com/drive/1oT4bUu1C1hsOGam1e3yQYlC0ZlcmoK03
"""
...
def preprocess(X_comment, Y_label=None, for_training=False, quite=True):
    ...
    if for_training:
        ...
        joblib.dump(X_comment_tokenized, r'/content/drive/MyDrive/datasets/X_comment_tokenized.joblib')
        joblib.dump(X_text_filtered, r'/content/drive/MyDrive/datasets/X_text_filtered.joblib')
        joblib.dump(Y_label_filtered, r'/content/drive/MyDrive/datasets/Y_label_filtered.joblib')
        ...
        joblib.dump(vocab_list,r'/content/drive/MyDrive/models/vocab_list.joblib')  
        ...
        vocab_list = joblib.load(r'/content/drive/MyDrive/models/vocab_list.joblib')
...
data_file_path = r'/content/drive/MyDrive/data/customer_reviews.csv'
...
if not load_processed_data:
    ...
    joblib.dump(X, r'/content/drive/MyDrive/datasets/X.joblib')
    joblib.dump(Y, r'/content/drive/MyDrive/datasets/Y.joblib')
    joblib.dump(X_test, r'/content/drive/MyDrive/datasets/X_test.joblib')
    joblib.dump(Y_test, r'/content/drive/MyDrive/datasets/Y_test.joblib')
    joblib.dump(vocab_list, r'/content/drive/MyDrive/models/vocab_list.joblib')
else:
    X = joblib.load(r'/content/drive/MyDrive/datasets/X.joblib')
    Y = joblib.load(r'/content/drive/MyDrive/datasets/Y.joblib')
    X_test = joblib.load(r'/content/drive/MyDrive/datasets/X_test.joblib')
    Y_test = joblib.load(r'/content/drive/MyDrive/datasets/Y_test.joblib')
    vocab_list = joblib.load(r'/content/drive/MyDrive/models/vocab_list.joblib')
    vocab_X_size = len(vocab_list)
...
if new_training:
    ...
    checkpoint_name = r'/content/drive/MyDrive/models/sentiment_GRU'+'_epoch{epoch:02d}_accuracy{accuracy:.4f}'+'.h5'
...
sess = tf.Session()
wr = tf.summary.FileWriter("/content/drive/My Drive/logs",sess.graph)
...
model = keras.models.load_model(r'/content/drive/MyDrive/models/sentiment_GRU_e poch50_accuracy0.9761.h5') # BEST model here
...
comment = ['Sp như hình hàng giao chậm']
...
#df.to_csv(r'/content/drive/MyDrive/data/test_output.csv',index=False)
